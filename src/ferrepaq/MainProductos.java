 ...
 * @author Omar Benítez
 */
public class MainProductos extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("consultorio12321PU").createEntityManager();
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nombreProducto}"), nombreProductoField, org.jdesktop.beansbinding.BeanProperty.create("text"));
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                MainProductos.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                MainProductos.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                MainProductos.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                MainProductos.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new MainProductos());
